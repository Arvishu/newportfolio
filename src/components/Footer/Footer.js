        ...
        <div className='footerContainer'>
            <div className='footerStyle'>
                ...
                <div className="iconPosition"> 
                    <a href="https://www.facebook.com/hugo.arvis/" target="_blank" rel="noopener noreferrer">
                ...
                <div className="iconPosition">
                    <a href="https://www.linkedin.com/in/hugo-arvis/" target="_blank" rel="noopener noreferrer">
                        <img alt="github" src={linkedin}
                            width="48" height="48"
                            title="lien vers mon profil linkedin" /></a>
                </div>
                <div className="iconPosition">
                    <a href="https://github.com/Arvishu" target="_blank" rel="noopener noreferrer">
